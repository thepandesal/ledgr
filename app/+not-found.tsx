...
const s = StyleSheet.create({
  ...
  title: { fontFamily: 'CalSans', fontSize: 22, color: '#0ccfcf', marginBottom: 16 },
  heading: { fontFamily: 'CalSans', fontSize: 28, color: '#425252', letterSpacing: -0.5 },
  sub: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: '#929090', textAlign: 'center', lineHeight: 18 },
  btn: { marginTop: 24, backgroundColor: '#425252', borderRadius: 999, paddingVertical: 12, paddingHorizontal: 32 },
  btnText: { fontFamily: 'DMSans_700Bold', fontSize: 13, color: '#fff' },
});
