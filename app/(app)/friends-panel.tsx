...
const st = StyleSheet.create({
  ...
  codeInput: { flex: 1, fontFamily: AppFont.regular, fontSize: 16, color: Colors.text, backgroundColor: Colors.surface, borderRadius: Radius.lg, paddingHorizontal: 14, paddingVertical: 11, borderWidth: 1, borderColor: Colors.borderMid },
