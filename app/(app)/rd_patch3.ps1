...
$before = $lines[0..2156]
$after  = $lines[2225..($lines.Length - 1)]
...
"Done. Lines: $($combined.Length)" | Out-File 'c:\Users\jhoeb\OneDrive\Documents\Work\Apps\Financial Help\ledgr\app\(app)\rd_result3.txt'
