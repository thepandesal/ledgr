...
const styles = StyleSheet.create({
  ...
  infoInput: { flex: 1, fontFamily: 'RobotoMono_400Regular', fontSize: 13, color: '#425252', padding: 0 },
  infoValue: { flex: 1, fontFamily: 'RobotoMono_400Regular', fontSize: 13, color: '#425252' },
  ...
  input: { backgroundColor: '#fafafa', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 11, fontFamily: 'RobotoMono_400Regular', fontSize: 13, color: '#425252', borderWidth: 1, borderColor: '#f0f0f0' },
