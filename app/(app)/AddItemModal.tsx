...
const s = StyleSheet.create({
  ...
  itemCardInputs: { flex: 1, flexDirection: 'row', gap: 8 },
  itemNameInput: { flex: 1, fontFamily: 'RobotoMono_400Regular', fontSize: 16, color: '#425252', backgroundColor: '#ffffff', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: '#e8e8e8' },
  itemCostInput: { width: 90, fontFamily: 'RobotoMono_700Bold', fontSize: 16, color: '#425252', backgroundColor: '#ffffff', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: '#e8e8e8', textAlign: 'right' },
