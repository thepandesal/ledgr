...
const s = StyleSheet.create({
  ...
  recordingType:    { fontFamily: 'Poppins-Regular', fontSize: 10, color: Colors.muted, letterSpacing: 0.4, textTransform: 'uppercase' },
  recordingName:    { fontFamily: 'Poppins-Medium', fontSize: 14, color: Colors.text, letterSpacing: 0.1, lineHeight: 20 },
