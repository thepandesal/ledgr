...
const s = StyleSheet.create({
  ...
  title:     { fontFamily: 'DMSans_600SemiBold', fontSize: 16, color: Colors.text },
  ...
  tabText:   { fontFamily: 'DMSans_400Regular', fontSize: 13, color: Colors.muted },
  tabTextActive: { fontFamily: 'DMSans_600SemiBold', fontSize: 13, color: Colors.text },
