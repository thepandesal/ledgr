...
export default function PayModal({ visible, onClose, recording, items, filledPeople, step, setStep, mode, setMode, manualAmount, setManualAmount, selectedPeople, setSelectedPeople, accounts, account, setAccount, date, setDate, complete, setComplete, loading, getAmount, onConfirm }: Props) {
